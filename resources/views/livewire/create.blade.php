<button type="button" wire:click.prevent="resetInputFields()" class="btn btn-primary" data-toggle="modal" data-target="#insertModal">
    Open Form
</button>

<!-- Modal -->
<div wire:ignore.self class="modal fade" id="insertModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
